...
public class _AccelerometerActivity extends FragmentActivity implements SensorEventListener {
    ...
    private static final String TAG = _AccelerometerActivity.class.getName();
